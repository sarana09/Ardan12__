...
// Вычисление и вывод необходимого количества ингредиентов для салата и супа
salad.calculateIngredients(numberOfPeople);
soup.calculateIngredients(numberOfPeople);
}
}
