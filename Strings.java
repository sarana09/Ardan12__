class Strings {
	public static void main(String args[]) {
		...
		System.out.println();
		if(str1.equals(str2))
			System.out.println("str1 and str2 эквивалентны");
		else
			System.out.println("str1 b str2 не эквивалентны");
		if(str1.equals(str3))
                        System.out.println("str1 and str3 эквивалентны");
                else
                        System.out.println("str1 b str3 не эквивалентны");
		...
		String str4 = "Строка для поиска подстройки. Значения: подстрока 1, подстрока 2, подстрока 3";
